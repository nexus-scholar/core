...
- P2 citation graph foundation now has unit, application, and feature coverage for graph construction, graph-package adapters, metrics, shortest paths, weighted persistence, and fake-provider snowballing rounds.
...
- Real provider citation traversal with fixtures.
